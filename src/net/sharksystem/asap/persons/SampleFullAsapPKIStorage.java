...
public class SampleFullAsapPKIStorage extends FullAsapPKIStorage {
    ...
    public void fillWithExampleData() throws ASAPSecurityException, IOException {
        ...
        ASAPCertificateStore francisStorage = null, gloriaStorage = null, hassanStorage = null, irisStorage;
        ...
        if(!this.getOwnerID().toString().equalsIgnoreCase(FRANCIS_ID.toString())) {
            ...
            francisStorage = new ASAPCertificateStoreImpl(certificateStorage, asapKeyStorage);
        ...
        if(!this.getOwnerID().toString().equalsIgnoreCase(GLORIA_ID.toString())) {
            ...
            gloriaStorage = new ASAPCertificateStoreImpl(certificateStorage, asapKeyStorage);
        ...
        if(!this.getOwnerID().toString().equalsIgnoreCase(HASSAN_ID.toString())) {
            ...
            hassanStorage = new ASAPCertificateStoreImpl(certificateStorage, asapKeyStorage);
        ...
        if(!this.getOwnerID().toString().equalsIgnoreCase(IRIS_ID.toString())) {
            ...
            irisStorage = new ASAPCertificateStoreImpl(certificateStorage, asapKeyStorage);
